...
const testDraft = '1132151765463400448';
var timerInterval;
...
function prepareBoard() {
    $.ajax({
		...
		success: function(data) {
            ...
            var seconds = 10; // THIS IS 10 SECONDS FOR TESTING PURPOSES, THE COMMENTED ONE ABOVE IS THE REAL TIME UNTIL THE DRAFT
            function timer() {
		...
		success: function(data) {
            ...
            data.forEach(pick => {
                ...
                if (pickID === currPick) {
                    ...
                    $('.pickContainer#'+pickID).removeClass('currentPick').css('background', getColor(pick.metadata.position))
